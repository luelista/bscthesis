...
% Meta Data for the title page
  ...
  \author{Maxi Weller}
  \referee{aaaaa}{bbbb}[c]
  \department{Fachbereich Informatik}
  \group{KOM - Multimedia Communications Lab }
  \tuprints{57580}{5758}
  \makethesistitle
  \affidavit{M. Weller}
...
Regarding the choice of web sites, an easy way is using a list of the most popular websites like the Alexa Top Sites.


There are different approaches to choose which web sites to measure, and 
