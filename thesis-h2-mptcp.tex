...
To finish this section on Multipath TCP, we give an introduction to the rule-based scheduler, a Multipath TCP scheduler, which makes its decisions based on interpreted script programs, allowing us to evaluate different scheduling approaches more straightforward.
